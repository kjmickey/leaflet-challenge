...
// var centerCoords = [41.29, -96.22]; // Omaha
// var centerCoords = [29.81, -95.68]; // Houston
// var centerCoords = [61.10, -150.00]; // Anchorage
var centerCoords = [28.00, -40.80]; // North Atlantic for world view

var mapZoomLevel = 3;   // start zoom level, shows most of N/S America, at least on my screen when using houston or omaha
...
// Wish I could figure out how to shrink these as you zoom in (or grow as you go out)
...
function createMap(earthquakes) {
  ...
  let darkmap = L.tileLayer(mapboxUrl, 
    ...
    id: "mapbox/dark-v10", 
    accessToken: API_KEY});
  let satellitemap = L.tileLayer(mapboxUrl, 
  ...
  legend.onAdd = function(map) {
    ...
    div.innerHTML += "<h4 style='margin:4px'>Depth (Miles)</h4><hr>" 
